	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url()."assets/images/bg-01.jpg"?>');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form class="login100-form validate-form flex-sb flex-w" action="<?php echo base_url()."index.php/hal_utama/aksi_daftar";?>" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Nama Akun is required">
						<input class="input100" type="text" name="nama" placeholder="Masukkan Nama Akun">
					...
					<div class="w-full text-center p-t-55">
						...
						<a href="<?php echo base_url()."index.php/hal_utama/";?>" class="txt2 bo1">
							Login disini
						</a>
					</div>
