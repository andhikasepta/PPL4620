...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo base_url()."index.php/hal_admin/"?>" title="Kembali Ke Beranda" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="" class="tip-bottom">Form</a> <a href="<?php echo base_url()."index.php/hal_admin/baca_form"?>" title="Form Tambah Data" class="current">Form Tambah Barang</a> </div>
    ...
    <div class="row-fluid">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form action="<?php echo base_url()."index.php/hal_admin/tambah_data"?>" method="POST" class="form-horizontal">
              <div class="control-group">
                <label class="control-label">Nama Barang :</label>
                <div class="controls">
                  <input type="text" name="nama_pr" class="span11" placeholder="Masukkan Nama Barang" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Jenis Barang :</label>
                <div class="controls">
                  <select name="jenis_pr">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="harga_pr" class="span11" placeholder="Masukkan Harga Barang" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Stock :</label>
                <div class="controls">
                  <input type="text" name="stock_pr" class="span11" placeholder="Masukkan Jumlah Stock Barang" />
                </div>
              </div>
